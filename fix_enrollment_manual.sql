-- Script để sửa enrollment thủ công cho các payment QR đã được approve
-- Chạy script này để tạo enrollment cho các payment đã approve nhưng chưa có enrollment
...
-- 3. Tìm các payment chưa có enrollment
...
-- 4. Tạo enrollment cho các payment chưa có (UNCOMMENT để chạy)
/*
