	...
	'inline-flex items-center justify-center whitespace-nowrap rounded-2xl text-sm font-bold ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 uppercase tracking-wide',
	{
		variants: {
			variant: {
				...
				primaryOutline: 'bg-white text-sky-500 hover:bg-slate-100 border border-b-4 active:border-b-0',
				secondary:
					'bg-primary text-primary-foreground hover:bg-primary/90 border-green-700 border-b-4 active:border-b-0',
				...
				custom: 'bg-gradient-to-r from-green-400 to-blue-500 hover:bg-slate-100 text-white border-b-4 border-indigo-600 active:border-b-0',
			},
			size: {
